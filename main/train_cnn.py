...
def main(): 
    ...
    # generate a list of random seed for each environment 
    seed_set = set() 
    ...
    checkpoint_callback = CheckpointCallback(save_freq=checkpoint_interval, 
                                             save_path=save_dir, 
                                             name_prefix="ppo_snake")
    
    # writing the training logs from stdout from a file 
